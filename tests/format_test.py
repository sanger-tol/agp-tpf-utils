...
def test_format_tpf():
    ...
    assert tpf.getvalue() == strip_leading_spaces(
        ...
        ## DESCRIPTION: Generated by PretextView Version 0.2.5
        ## HiC MAP RESOLUTION: 8666.611572 bp/texel
        ?	scaffold_12:1-row.end	chr1	PLUS
        GAP	TYPE-2	100
        ?	scaffold_12:23200-row.end	chr1	MINUS
        GAP	TYPE-2	200
        ?	scaffold_12:140113-row.end	chr1	PLUS
        ?	scaffold_3:1-row.end	chr1	UNKNOWN
        ?	scaffold_7:1-row.end	chrX	PLUS
        GAP	SHORT-ARM	1300000
        ?	scaffold_7:11049229141-row.end	chrX	PLUS
        """
    )
