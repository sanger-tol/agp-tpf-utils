...
def test_gfasta_stats(genome_file):
    ...
    assert io.getvalue() == (
        ...
        "{'gfa_name': 'Average scaffold length', 'col_name': 'scaffold_length_mean', 'category': 'scaffold', 'measure': 'mean', 'value': 353.67}\n"
        ...
        "{'gfa_name': 'Largest scaffold', 'col_name': 'scaffold_longest', 'category': 'scaffold', 'measure': 'longest', 'value': 609}\n"
        "{'gfa_name': 'Smallest scaffold', 'col_name': 'scaffold_shortest', 'category': 'scaffold', 'measure': 'shortest', 'value': 160}\n"
        ...
        "{'gfa_name': 'Average contig length', 'col_name': 'contig_length_mean', 'category': 'contig', 'measure': 'mean', 'value': 80.85}\n"
        ...
        "{'gfa_name': 'Largest contig', 'col_name': 'contig_longest', 'category': 'contig', 'measure': 'longest', 'value': 216}\n"
        "{'gfa_name': 'Smallest contig', 'col_name': 'contig_shortest', 'category': 'contig', 'measure': 'shortest', 'value': 15}\n"
        "{'gfa_name': '# gaps in scaffolds', 'col_name': 'gaps_in_scaffolds', 'category': 'gap', 'measure': 'count', 'value': 10}\n"
        "{'gfa_name': 'Total gap length in scaffolds', 'col_name': 'gap_length_in_scaffolds', 'category': 'gap', 'measure': 'total', 'value': 10}\n"
        "{'gfa_name': 'Average gap length in scaffolds', 'col_name': 'gap_length_in_scaffolds_mean', 'category': 'gap', 'measure': 'mean', 'value': 1.0}\n"
        ...
        "{'gfa_name': 'Largest gap in scaffolds', 'col_name': 'gap_in_scaffolds_longest', 'category': 'gap', 'measure': 'longest', 'value': 1}\n"
        "{'gfa_name': 'Smallest gap in scaffolds', 'col_name': 'gap_in_scaffolds_shortest', 'category': 'gap', 'measure': 'shortest', 'value': 1}\n"
        ...
        "{'gfa_name': '# soft-masked bases', 'col_name': 'soft_masked_bases', 'category': 'contig', 'measure': 'soft_masked_bases', 'value': 1046}\n"
        ...
        "{'gfa_name': 'Average segment length', 'col_name': 'segment_length_mean', 'category': 'segment', 'measure': 'mean', 'value': 79.69}\n"
...
if __name__ == "__main__":
    file = Path(__file__).parent / "gfa_stats_after.txt"
